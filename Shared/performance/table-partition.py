...
# ptbwa_data_validator = PtbwaDataValidatior(PtbwaDataTypes.DATABASE_AUTOREPORT.value, PtbwaDataTypes.TABLE_NAME_TYPE_CONTAINS.value, ["tt_fb"])
...
# if s.startswith(("date", "Date")) or s.endswith(("date", "Date")):
#     print("들어온다")