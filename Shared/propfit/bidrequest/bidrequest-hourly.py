...
df = spark.read.json(f"dbfs:/mnt/ptbwa-propfit/stats/propfit-request-hourly/year={stats_datetime_year}/month={stats_datetime_month}/day={stats_datetime_day}/hour={stats_datetime_hour}/*")
# df.display()
...
delete_query = f"""
delete 
from cream.propfit_request_hourly
...
df.write.mode('append').partitionBy("year", "month", "day", "hour").saveAsTable("cream.propfit_request_hourly")
