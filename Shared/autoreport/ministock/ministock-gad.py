...
#                 WHERE 
#                   campaign.id IN ({self.campaign_ids})
#                   AND segments.date between '2023-03-01' and '2023-03-10'
#             """
...
#                         "adFinalUrl": ad.final_urls,
                    ...
                    print(ad.final_app_urls)
                    
            self.table_path = self.create_table_path("AD")
        except Exception as e:
...
#             """
    ...
    def create_json_rdd(self):
        ...
        try:
            ...
            setattr(self, f"{self.domain.lower()}_df", spark.read.json(json_rdd))
        except Exception as e:
    ...
    def create_table_path(self, domain):
        ...
        return f"{self.base_db}.{self.channel}_{self.advertiser}_{domain.lower()}_stats" # e.g. gad_series_adgroup_stats
