...
class FacebookMarketingApi(AutoReportAPI):
    ...
    def __init__(self, customer_id) -> None:
        ...
        self.config_name = "facebook_marketing_api_client.pickle"
...
#             }
            ...
            request_params = {
                "fields": fields,
                "access_token": "EAAZAcjVsMlzUBAOvThQ7aoK4Fql0PJpXOHioVatfZAnzGkahOjf5CcLYuN3RWtIKBgXPooibCwK1PvOLokb7e4pBMrVd4mMjZAgNo3ZBZBFI64HvRAD1kyZAQWlAs8ZBMjBZBY4tzzE28xiEJ1w0w3E1XcooSFWnFisofhbs9O1hs9ZCZBRU28k2FH"
            }
...
#         return f"{self.base_db}.{self.channel}_{self.advertiser}_ad_stats"
        if self.wash :
            return f"{self.base_db}.{self.channel}_{self.advertiser}_ad_wash_stats"
        else :
            return f"{self.base_db}.{self.channel}_{self.advertiser}_ad_stats"
...
# facebook_marketing_api.df.drop("impression_device").write.mode("append").saveAsTable("auto_report.tt_fb_kakaopay_ad_stats")
