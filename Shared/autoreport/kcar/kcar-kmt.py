...
class KakaoMomentApi(AutoReportAPI):
    ...
    def __init__(self, customer_id, s_date=None, e_date=None) -> None:
        ...
        self.s_date = datetime.strftime(datetime.now() + timedelta(hours=9) - timedelta(days=1), "%Y-%m-%d")
        self.e_date = datetime.strftime(datetime.now() + timedelta(hours=9) - timedelta(days=1), "%Y-%m-%d")
