...
#             'endDate': '2022-11-30'
        ...
        "_get_access_token": "grant_type=client_credentials&client_id=5b253108c36749c7a39fcceff6aacae4&client_secret=H%2BoAuKNkgUX5doJlGOwPIyLRdctDk5CATuyfXz3qdIO6",
    }
...
class KcarCriteoAPI(AutoReportAPI):
    ...
    def __init__(self, kcar_criteo_data:KcarCriteoData) -> None:
        ...
        self.d_minus_one = datetime.strftime(self.current - timedelta(days=1), "%Y-%m-%d")
        self.d_minus_two = datetime.strftime(self.current - timedelta(days=2), "%Y-%m-%d")
...
# kcar_criteo_api.statistics_report_df.display()
...
# MAGIC 
# MAGIC #### Test
# MAGIC - (Default) OAuth Expiration 900s
...
# payload = "grant_type=client_credentials&client_id=5b253108c36749c7a39fcceff6aacae4&client_secret=H%2BoAuKNkgUX5doJlGOwPIyLRdctDk5CATuyfXz3qdIO6"
# headers = {
#     "accept": "application/json",
#     "content-type": "application/x-www-form-urlencoded"
# }
...
#     {
#       "AdId": "717880",
#       "Ad": "280121_Re_Design_Banner",
#       "CampaignId": "206952",
#       "Campaign": "MO Web Consideration_Commerce",
#       "AdsetId": "245924",
#       "Adset": "MO Web Consideration_Commerce",
#       "Device": "Desktop",
#       "ChannelId": "1",
#       "Channel": "WEB",
#       "Currency": "USD",
...
# with open("/dbfs/FileStore/configs/criteo_api_client.pickle", "wb") as f:
...
# table_name = "tt_auto_report.criteo_kcar_ad_stats"
# kcar_criteo_api.statistics_report_df.write.mode("append").saveAsTable(table_name)